function [RT,code,cor,winnings]=singleTrial(w,rect,crectP,Actions,text,imaget,acor,corFB,trick,js)
...
if code==1 | code==2 | code==3;
    ...
    if winnings>0 %also add winnings if correct
